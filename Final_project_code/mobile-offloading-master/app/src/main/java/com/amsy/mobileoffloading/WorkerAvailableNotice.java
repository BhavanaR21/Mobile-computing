...
public class WorkerAvailableNotice extends AppCompatActivity {
    ...
    private void beginWorkerTask() {
        Intent intent = new Intent(getApplicationContext(), WorkerTask.class);
    ...
    void connectionInfo(String text, boolean available) {
